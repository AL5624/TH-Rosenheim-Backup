 ...
 * Created on 10/6/17.
 */
public class SimpleListInterfaceTest
{
	...
	void testFilterAnonymousClass(){
		SimpleList result = (SimpleList) testList.filter(new SimpleFilter() {
			@Override
	...
	void testFilterLambda(){
		SimpleList result = (SimpleList) testList.filter(o -> ((int)o) % 2 == 0);
		for(Object o : result){
			int i = (int)o;
			assertTrue(i % 2 == 0);
		}
