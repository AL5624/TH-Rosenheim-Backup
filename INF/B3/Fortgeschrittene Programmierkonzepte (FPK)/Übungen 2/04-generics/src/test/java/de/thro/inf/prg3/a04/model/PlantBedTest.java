...
class PlantBedTest {
    ...
    void testGetPlantsByColorYellow() {
        SimpleListInterface<Flower> flowers = flowerBed.getPlantsByColor(PlantColor.YELLOW);
    ...
    void testGetPlantsByColorRed() {
        SimpleListInterface<Flower> flowers = flowerBed.getPlantsByColor(PlantColor.RED);
    ...
    void testGetPlantsByColorGreen() {
        SimpleListInterface<Flower> flowers = flowerBed.getPlantsByColor(PlantColor.GREEN);
