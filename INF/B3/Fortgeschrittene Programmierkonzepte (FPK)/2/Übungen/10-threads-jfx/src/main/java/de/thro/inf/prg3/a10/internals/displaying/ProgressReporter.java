...
public final class ProgressReporter {
	...
	private final I_KitchenHatch IKitchenHatch;
	...
	public ProgressReporter(I_KitchenHatch IKitchenHatch, int cookCount, int waiterCount, int totalOrderCount, int kitchenHatchCapacity) {
		...
		this.IKitchenHatch = IKitchenHatch;
	...
	public void updateProgress() {
		setKitchenHatchProgress(((double) this.IKitchenHatch.getDishesCount()) / this.kitchenHatchCapacity);
		setOrderQueueProgress(((double) this.IKitchenHatch.getOrderCount()) / this.totalOrderCount);
