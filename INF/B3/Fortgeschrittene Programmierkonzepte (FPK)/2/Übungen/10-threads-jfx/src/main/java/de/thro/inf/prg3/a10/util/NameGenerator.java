...
public final class NameGenerator {
	...
	public NameGenerator() {
		...
		adjectives = gson.fromJson(new InputStreamReader(Objects.requireNonNull(getClass().getResourceAsStream("/nameGenerator/adjectives.json"))), String[].class);
		names = gson.fromJson(new InputStreamReader(Objects.requireNonNull(getClass().getResourceAsStream("/nameGenerator/well-known-persons.json"))), String[].class);
		dishes = gson.fromJson(new InputStreamReader(Objects.requireNonNull(getClass().getResourceAsStream("/nameGenerator/dishes.json"))), String[].class);
	}
