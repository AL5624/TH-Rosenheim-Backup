...
//TODO: implement sig_interrupt_usr1 handler
...
int main(int argc, char** argv)
{
    ...
    //TODO: register SIGUSR1 signal

    printf("signal_example PID is: %d\n", getpid());
    ...
    if (argc == 1){
        ...
        printf("signal_example returned successful after 90 minutes\n");
