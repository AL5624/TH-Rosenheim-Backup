========================================================================
    KONSOLENANWENDUNG: Sortieren-Projektübersicht
========================================================================

Diese Sortieren-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Sortieren-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Sortieren.pch und eine 
