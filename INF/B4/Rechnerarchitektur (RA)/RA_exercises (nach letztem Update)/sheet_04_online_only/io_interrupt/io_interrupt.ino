...
void setup(){
  ...
  //configure PINs
  pinMode(BUTTON_PIN, /*TODO*/); //TODO: configure as INPUT or OUTPUT
  pinMode(LED_PIN,    /*TODO*/); //TODO: configure as INPUT or OUTPUT
...
void isr_button_pressed(){
  if (millis() - time_prev_rising_edge > 50) { //only react on rising edges every 50 ms
