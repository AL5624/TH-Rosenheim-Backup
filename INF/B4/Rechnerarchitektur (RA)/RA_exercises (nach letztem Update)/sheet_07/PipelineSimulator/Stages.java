...
public class Stages extends Panel
{
	...
	Stages()
	{
		...
		constraints.fill = GridBagConstraints.BOTH;
		constraints.anchor = GridBagConstraints.CENTER;
		Label Lfetch = new Label("Get Instruction", Label.CENTER);
		...
		constraints.fill = GridBagConstraints.BOTH;
		constraints.anchor = GridBagConstraints.CENTER;
		Label Ldecode = new Label("Load Operands", Label.CENTER);
		...
		constraints.fill = GridBagConstraints.BOTH;
		constraints.anchor = GridBagConstraints.CENTER;
		Label Lex = new Label("Compute Instruction", Label.CENTER);
		...
		constraints.fill = GridBagConstraints.BOTH;
		constraints.anchor = GridBagConstraints.CENTER;
		Label Lmem = new Label("Memory Access", Label.CENTER);
		...
		constraints.fill = GridBagConstraints.BOTH;
		constraints.anchor = GridBagConstraints.CENTER;
		Label Lwb = new Label("Save Result Into Register", Label.CENTER);
